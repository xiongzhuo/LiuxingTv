...
public class SmoothScrollListView extends ListView implements OnKeyListener {
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        //获取listview  item的count，一定要是由adapter获得，不能通过listView，因为listView是动态添加删除孩子的，可以打印一下比较看看
...
//					this.setSelection(itemsCount - 1);
                ...
                this.smoothScrollBy(itemHeight, scrollDuration);
//				this.smoothScrollToPositionFromTop(currentItemPosition + 1, 0, scrollDuration);
                return false;
            }
        }
