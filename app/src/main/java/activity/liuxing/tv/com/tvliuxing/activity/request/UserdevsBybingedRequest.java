...
public class UserdevsBybingedRequest {
    private Context context;
    private SharedPreferencesDB sharedPreferencesDB;
    private Handler handler;
    private DialogView dialogView;

    public UserdevsBybingedRequest(Context context, SharedPreferencesDB sharedPreferencesDB, Handler handler) {
    ...
    public void requestCode() throws Exception {
        ...
        RequestParams params = new RequestParams(Constant.URL_USERDEVSBYBINGEDTVSN);
        ...
        x.http().post(params, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String json) {
                JsonResult<Userdevs> result = new JsonResult<Userdevs>();
                try {
                    if (null != dialogView) {
                        dialogView.cancel();
                    }
