...
public class HomeArcView extends View {
    ...
    private int[] clotherLook = {Color.parseColor("#88e0c3"), Color.parseColor("#f7d995"), Color.parseColor("#c5ddaa")};
    private int[] clotherDress = {Color.parseColor("#c1e56b"), Color.parseColor("#a4f29b"), Color.parseColor("#a9f092")};
    ...
    public void setValue(int score, int mPage) {
        ...
        tb = res.getDimension(R.dimen.dp10);
    ...
    private void drawPoint(Canvas canvas) {
        ...
        canvas.drawCircle((float) (9.0f * tb + 8.5f * tb * Math.sin(3.6 * pointCount * Math.PI / 180)),
                (float) (9.0f * tb - 8.5f * tb * Math.cos(3.6 * pointCount * Math.PI / 180)), 5, paint_big_text);
